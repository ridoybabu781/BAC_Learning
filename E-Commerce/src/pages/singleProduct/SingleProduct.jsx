...
export default function SingleProduct() {
  ...
  const isInWishlist = wishlist.some((p) => p.product.id === product.id);
      ...
      <div className="container m-auto mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-10 my-12">
        ...
        <div className="space-y-4">
          ...
          {product.availability === "In Stock" ? (
            ...
            >
              {isInWishlist ? "Wished" : "Add to Wishlist"}
            </button>
          )}
        </div>
        ...
        <div>
          <div className="flex gap-4 mb-2">
            {["detailedDescription", "additionalInfo", "customerFeedback"].map(
              (portion) => (
                <button
                  key={portion}
                ...
                >
                  {portion === "detailedDescription"
                    ? "Detailed Description"
                    : portion === "additionalInfo"
